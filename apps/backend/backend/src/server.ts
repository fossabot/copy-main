...
// Plugin Conflict Intelligence endpoints (protected)
app.post('/api/plugins/preflight-check', authMiddleware, csrfProtection, pluginsController.preflightCheck.bind(pluginsController));
app.post('/api/plugins/install', authMiddleware, csrfProtection, pluginsController.installPlugin.bind(pluginsController));
app.get('/api/plugins/conflicts', authMiddleware, pluginsController.getConflictEvents.bind(pluginsController));
