...
import { AnalysisData } from './repository-analysis.service.js';

@Injectable()
export class PromptGeneratorService {
  /**
   * Generate the production readiness assessment prompt in Arabic
   */
  generatePrompt(
    ...
    const fileStructureText = analysisData.fileStructure
      .slice(0, 100)
      .join('\n');
...

{
  "metadata": {
    ...
    "primaryLanguages": ${JSON.stringify(analysisData.primaryLanguages)}
  },
